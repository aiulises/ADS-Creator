...
import type { AdTemplate, Platform } from './types';
...
export const TwitterIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z"/></svg>
);
...
export const TikTokIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M16 8.11V4h-4v12a4 4 0 1 1-4-4h4"></path></svg>
);
...
export const PackageIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M21 10V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v2"></path><path d="M21 14v5a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-5"></path><path d="m3.3 9.9 8.7 5.1 8.7-5.1"></path><line x1="12" x2="12" y1="22" y2="15"></line></svg>
);

export const SparklesIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 2a2.4 2.4 0 0 0-1.8 4.2l-2.9 2.9a2.4 2.4 0 0 0 0 3.4l2.9 2.9A2.4 2.4 0 0 0 12 22a2.4 2.4 0 0 0 1.8-4.2l2.9-2.9a2.4 2.4 0 0 0 0-3.4l-2.9-2.9A2.4 2.4 0 0 0 12 2Z"></path><path d="M16 16 22 22"></path><path d="M8 8 2 2"></path></svg>
);
...
export const XIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><line x1="18" x2="6" y1="6" y2="18"></line><line x1="6" x2="18" y1="6" y2="18"></line></svg>
);
...
export const adTemplates: AdTemplate[] = [
    { id: 'ugc', name: 'UGC Style', desc: 'Casual, authentic, holding product', platform: 'TikTok/Instagram' },
    { id: 'lifestyle', name: 'Lifestyle Shot', desc: 'Using product in daily life', platform: 'Instagram' },
    { id: 'unboxing', name: 'Unboxing', desc: 'Excited reaction, product reveal', platform: 'YouTube/TikTok' },
    { id: 'comparison', name: 'Before/After', desc: 'Show product results', platform: 'Facebook/Instagram' },
    { id: 'tutorial', name: 'How-to Demo', desc: 'Teaching while using product', platform: 'YouTube' }
];

export const platforms: Platform[] = [
    { id: 'instagram', name: 'Instagram', ratio: '1:1', icon: InstagramIcon },
    { id: 'tiktok', name: 'TikTok', ratio: '9:16', icon: TikTokIcon },
    { id: 'linkedin', name: 'LinkedIn', ratio: '16:9', icon: LinkedInIcon }
];